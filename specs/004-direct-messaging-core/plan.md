...
в ROADMAP; в рамках 004 история хранится в PG без ограничения — обоснование: расчёт
объёмов ([research.md §12](./research.md)) укладывается в вертикальный PG на горизонте
фичи, SQL-паттерны приложения не меняются при вводе archival позже.
