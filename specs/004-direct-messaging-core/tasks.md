...
- [ ] T066 [P] k6-сценарий: пары VU (отправка + подтверждение, SSE-приём, p95 ≤ 2 с — SC-001/005), флуд-ветка — только `429` без 5xx — в `load/k6/messaging.smoke.js`
...
- Тесты историй помечены [P] — пишутся параллельно (T007 ∥ T008; T029 ∥ T030; T047 ∥ T048 ∥ T049)
